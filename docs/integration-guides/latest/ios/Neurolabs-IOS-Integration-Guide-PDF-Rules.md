...
This file defines the canonical rules for generating `Neurolabs-IOS-Integration-Guide.pdf` from `Neurolabs-IOS-Integration-Guide.md`.
...
- Input file: `Neurolabs-IOS-Integration-Guide.md` (repo root)
- Output file: `Neurolabs-IOS-Integration-Guide.pdf` (repo root)
...
- Output path remains `Neurolabs-IOS-Integration-Guide.pdf` in repo root.
