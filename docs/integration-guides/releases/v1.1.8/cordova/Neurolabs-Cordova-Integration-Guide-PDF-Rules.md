...
This file defines the canonical rules for generating `Neurolabs-Cordova-Integration-Guide.pdf` from `Neurolabs-Cordova-Integration-Guide.md`.
...
- Input file: `Neurolabs-Cordova-Integration-Guide.md` (repo root)
- Output file: `Neurolabs-Cordova-Integration-Guide.pdf` (repo root)
...
- Output path remains `Neurolabs-Cordova-Integration-Guide.pdf` in repo root.

## Suggested Implementation
- Use Python + ReportLab.
